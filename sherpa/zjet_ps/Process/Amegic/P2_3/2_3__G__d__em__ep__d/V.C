...
extern "C" Values* Getter_V2_3__G__d__em__ep__d(Basic_Sfuncs* bs) {
  return new V2_3__G__d__em__ep__d(bs);
}

V2_3__G__d__em__ep__d::V2_3__G__d__em__ep__d(Basic_Sfuncs* _BS) :
     Basic_Func(0,_BS),
     Basic_Zfunc(0,_BS),
     Basic_Xfunc(0,_BS),
     Basic_Pfunc(0,_BS)
...
V2_3__G__d__em__ep__d::~V2_3__G__d__em__ep__d()
{
  if (Z)  delete[] Z;
  if (f)  delete[] f;
  if (c)  delete[] c;
...
Complex V2_3__G__d__em__ep__d::Evaluate(int m,int n)
{
...
void V2_3__G__d__em__ep__d::Calculate_M0()
{
  M[0][0] = -Z[18]*Z[8]*Z[7];
  M[0][1] = -Z[29]*Z[28]*Z[17];
}

void V2_3__G__d__em__ep__d::Calculate_M1()
{
  M[1][1] = -(Z[32]*Z[17]-Z[30]*Z[22])*Z[29];
}

void V2_3__G__d__em__ep__d::Calculate_M2()
{
  M[2][1] = Z[29]*Z[27]*Z[40];
}

void V2_3__G__d__em__ep__d::Calculate_M3()
{
  M[3][0] = -(Z[46]*Z[12]+Z[45]*Z[7])*Z[18];
  M[3][1] = (Z[31]*Z[40]+Z[30]*Z[36])*Z[29];
}

void V2_3__G__d__em__ep__d::Calculate_M12()
{
  M[12][0] = -Z[18]*Z[8]*Z[49];
  M[12][1] = -Z[29]*Z[28]*Z[55];
}

void V2_3__G__d__em__ep__d::Calculate_M13()
{
  M[13][1] = -(Z[32]*Z[55]-Z[30]*Z[58])*Z[29];
}

void V2_3__G__d__em__ep__d::Calculate_M14()
{
  M[14][1] = Z[29]*Z[27]*Z[67];
}

void V2_3__G__d__em__ep__d::Calculate_M15()
{
  M[15][0] = -(Z[46]*Z[52]+Z[45]*Z[49])*Z[18];
  M[15][1] = (Z[31]*Z[67]+Z[30]*Z[64])*Z[29];
}

void V2_3__G__d__em__ep__d::Calculate_M16()
{
  M[16][0] = -(Z[13]*Z[78]+Z[8]*Z[74])*Z[18];
  M[16][1] = (Z[80]*Z[26]+Z[79]*Z[22])*Z[29];
}

void V2_3__G__d__em__ep__d::Calculate_M17()
{
  M[17][1] = Z[29]*Z[81]*Z[22];
}

void V2_3__G__d__em__ep__d::Calculate_M18()
{
  M[18][1] = -(Z[28]*Z[44]-Z[80]*Z[40])*Z[29];
}

void V2_3__G__d__em__ep__d::Calculate_M19()
{
  M[19][0] = -Z[18]*Z[46]*Z[78];
  M[19][1] = -Z[29]*Z[32]*Z[44];
}

void V2_3__G__d__em__ep__d::Calculate_M28()
{
  M[28][0] = -(Z[13]*Z[87]+Z[8]*Z[84])*Z[18];
  M[28][1] = (Z[80]*Z[61]+Z[79]*Z[58])*Z[29];
}

void V2_3__G__d__em__ep__d::Calculate_M29()
{
  M[29][1] = Z[29]*Z[81]*Z[58];
}

void V2_3__G__d__em__ep__d::Calculate_M30()
{
  M[30][1] = -(Z[28]*Z[70]-Z[80]*Z[67])*Z[29];
}

void V2_3__G__d__em__ep__d::Calculate_M31()
{
