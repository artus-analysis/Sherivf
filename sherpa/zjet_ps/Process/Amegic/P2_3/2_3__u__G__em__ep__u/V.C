...
extern "C" Values* Getter_V2_3__u__G__em__ep__u(Basic_Sfuncs* bs) {
  return new V2_3__u__G__em__ep__u(bs);
}

V2_3__u__G__em__ep__u::V2_3__u__G__em__ep__u(Basic_Sfuncs* _BS) :
     Basic_Func(0,_BS),
     Basic_Zfunc(0,_BS),
     Basic_Xfunc(0,_BS),
     Basic_Pfunc(0,_BS)
...
V2_3__u__G__em__ep__u::~V2_3__u__G__em__ep__u()
{
  if (Z)  delete[] Z;
  if (f)  delete[] f;
  if (c)  delete[] c;
...
Complex V2_3__u__G__em__ep__u::Evaluate(int m,int n)
{
