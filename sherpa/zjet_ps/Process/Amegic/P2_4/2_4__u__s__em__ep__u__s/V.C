...
extern "C" Values* Getter_V2_4__u__s__em__ep__u__s(Basic_Sfuncs* bs) {
  return new V2_4__u__s__em__ep__u__s(bs);
}

V2_4__u__s__em__ep__u__s::V2_4__u__s__em__ep__u__s(Basic_Sfuncs* _BS) :
     Basic_Func(0,_BS),
     Basic_Zfunc(0,_BS),
     Basic_Pfunc(0,_BS)
{
...
V2_4__u__s__em__ep__u__s::~V2_4__u__s__em__ep__u__s()
{
  if (Z)  delete[] Z;
  if (f)  delete[] f;
  if (c)  delete[] c;
...
Complex V2_4__u__s__em__ep__u__s::Evaluate(int m,int n)
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M0()
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M1()
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M12()
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M13()
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M16()
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M17()
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M28()
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M29()
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M34()
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M35()
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M46()
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M47()
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M50()
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M51()
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M62()
{
...
void V2_4__u__s__em__ep__u__s::Calculate_M63()
{
