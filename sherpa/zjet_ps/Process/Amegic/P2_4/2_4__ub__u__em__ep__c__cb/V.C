...
extern "C" Values* Getter_V2_4__ub__u__em__ep__c__cb(Basic_Sfuncs* bs) {
  return new V2_4__ub__u__em__ep__c__cb(bs);
}

V2_4__ub__u__em__ep__c__cb::V2_4__ub__u__em__ep__c__cb(Basic_Sfuncs* _BS) :
     Basic_Func(0,_BS),
     Basic_Zfunc(0,_BS),
     Basic_Pfunc(0,_BS)
{
...
V2_4__ub__u__em__ep__c__cb::~V2_4__ub__u__em__ep__c__cb()
{
  if (Z)  delete[] Z;
  if (f)  delete[] f;
  if (c)  delete[] c;
...
Complex V2_4__ub__u__em__ep__c__cb::Evaluate(int m,int n)
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M0()
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M1()
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M2()
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M3()
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M12()
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M13()
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M14()
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M15()
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M48()
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M49()
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M50()
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M51()
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M60()
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M61()
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M62()
{
...
void V2_4__ub__u__em__ep__c__cb::Calculate_M63()
{
