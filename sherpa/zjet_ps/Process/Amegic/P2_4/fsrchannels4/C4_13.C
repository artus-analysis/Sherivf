...
namespace PHASIC {
  class C4_13 : public Single_Channel {
    ...
    Info_Key m_kI_2_3,m_kTC_0__1_4_23_5,m_kTC_0__1__235_4,m_kZS_205;
    Vegas* p_vegas;
  public:
...
void C4_13::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  Vec4D  p1_4 = p[1]-p[4];
  CE.TChannelMomenta(p[0],p1_4,p23,p[5],s23,s5,0.,m_alpha,1.,-1.,m_amct,0,ran[4],ran[5]);
...
void C4_13::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  ...
  Vec4D  p1_4 = p[1]-p[4];
  if (m_kTC_0__1_4_23_5.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0__1_4_23_5<<CE.TChannelWeight(p[0],p1_4,p23,p[5],0.,m_alpha,1.,-1.,m_amct,0,m_kTC_0__1_4_23_5[0],m_kTC_0__1_4_23_5[1]);
  wt *= m_kTC_0__1_4_23_5.Weight();

  rans[4]= m_kTC_0__1_4_23_5[0];
  rans[5]= m_kTC_0__1_4_23_5[1];
       ...
       : Single_Channel(nin,nout,fl)
{
  ...
  m_kTC_0__1_4_23_5.Assign(std::string("TC_0__1_4_23_5"),2,0,info);
...
{
  return std::string("CG2$I_2_3$MP23_23$MTH_235$TC_0__1_4_23_5$TC_0__1__235_4$ZS_205$");
}
