...
namespace PHASIC {
  class C4_28 : public Single_Channel {
    double m_amct,m_alpha,m_ctmax,m_ctmin;
    Info_Key m_kI_2_3,m_kTC_0__1_4_5_23,m_kTC_0__1__235_4,m_kZS_205;
    Vegas* p_vegas;
  public:
    C4_28(int,int,Flavour*,Integration_Info * const);
    ~C4_28();
...
extern "C" Single_Channel * Getter_C4_28(int nin,int nout,Flavour* fl,Integration_Info * const info) {
  return new C4_28(nin,nout,fl,info);
}

void C4_28::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  CE.TChannelMomenta(p[0],p[1],p235,p[4],s235,s4,0.,m_alpha,m_ctmax,m_ctmin,m_amct,0,ran[2],ran[3]);
  Vec4D  p1_4 = p[1]-p[4];
  CE.TChannelMomenta(p[0],p1_4,p[5],p23,s5,s23,0.,m_alpha,1.,-1.,m_amct,0,ran[4],ran[5]);
  CE.Isotropic2Momenta(p23,s2,s3,p[2],p[3],ran[6],ran[7]);
}

void C4_28::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  double wt = 1.;
  Vec4D p2345=p[0]+p[1];
  double s2345_max = p2345.Abs2();
  ...
  m_ctmax = cuts->cosmax[1][4];
  m_ctmin = cuts->cosmin[1][4];
  if (m_kTC_0__1__235_4.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0__1__235_4<<CE.TChannelWeight(p[0],p[1],p235,p[4],0.,m_alpha,m_ctmax,m_ctmin,m_amct,0,m_kTC_0__1__235_4[0],m_kTC_0__1__235_4[1]);
  wt *= m_kTC_0__1__235_4.Weight();

  rans[2]= m_kTC_0__1__235_4[0];
  rans[3]= m_kTC_0__1__235_4[1];
  Vec4D  p1_4 = p[1]-p[4];
  if (m_kTC_0__1_4_5_23.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0__1_4_5_23<<CE.TChannelWeight(p[0],p1_4,p[5],p23,0.,m_alpha,1.,-1.,m_amct,0,m_kTC_0__1_4_5_23[0],m_kTC_0__1_4_5_23[1]);
  wt *= m_kTC_0__1_4_5_23.Weight();

  rans[4]= m_kTC_0__1_4_5_23[0];
  rans[5]= m_kTC_0__1_4_5_23[1];
...
C4_28::C4_28(int nin,int nout,Flavour* fl,Integration_Info * const info)
       : Single_Channel(nin,nout,fl)
{
  name = std::string("C4_28");
  rannum = 8;
  ...
  m_kTC_0__1_4_5_23.Assign(std::string("TC_0__1_4_5_23"),2,0,info);
  m_kTC_0__1__235_4.Assign(std::string("TC_0__1__235_4"),2,0,info);
...
void C4_28::ISRInfo(int & type,double & mass,double & width)
{
  type  = 2;
  mass  = 205.1721;
  width = 0.;
...
void C4_28::AddPoint(double Value)
{
  Single_Channel::AddPoint(Value);
  p_vegas->AddPoint(Value,rans);
}
std::string C4_28::ChID()
{
  return std::string("CG2$I_2_3$MP23_23$MTH_235$TC_0__1_4_5_23$TC_0__1__235_4$ZS_205$");
}
