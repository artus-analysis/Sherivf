...
namespace PHASIC {
  class C4_18 : public Single_Channel {
    ...
    Info_Key m_kI_2_3,m_kI_4_5,m_kTC_0__1__23_45,m_kZS_136;
    Vegas* p_vegas;
  public:
...
void C4_18::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  CE.TChannelMomenta(p[0],p[1],p23,p45,s23,s45,0.,m_alpha,1.,-1.,m_amct,0,ran[2],ran[3]);
...
void C4_18::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  ...
  if (m_kTC_0__1__23_45.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0__1__23_45<<CE.TChannelWeight(p[0],p[1],p23,p45,0.,m_alpha,1.,-1.,m_amct,0,m_kTC_0__1__23_45[0],m_kTC_0__1__23_45[1]);
  wt *= m_kTC_0__1__23_45.Weight();

  rans[2]= m_kTC_0__1__23_45[0];
  rans[3]= m_kTC_0__1__23_45[1];
       ...
       : Single_Channel(nin,nout,fl)
{
  ...
  m_kTC_0__1__23_45.Assign(std::string("TC_0__1__23_45"),2,0,info);
...
{
  return std::string("CG2$I_2_3$I_4_5$MP23_23$MTH_45$TC_0__1__23_45$ZS_136$");
}
