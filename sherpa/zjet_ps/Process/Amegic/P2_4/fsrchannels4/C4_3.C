...
namespace PHASIC {
  class C4_3 : public Single_Channel {
    ...
    Info_Key m_kI_2_3,m_kTC_0_5_1__4_23,m_kTC_0__1__5_234,m_kZS_205;
    Vegas* p_vegas;
  public:
...
void C4_3::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  Vec4D  p0_5 = p[0]-p[5];
  CE.TChannelMomenta(p0_5,p[1],p[4],p23,s4,s23,0.,m_alpha,1.,-1.,m_amct,0,ran[4],ran[5]);
...
void C4_3::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  ...
  Vec4D  p0_5 = p[0]-p[5];
  if (m_kTC_0_5_1__4_23.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0_5_1__4_23<<CE.TChannelWeight(p0_5,p[1],p[4],p23,0.,m_alpha,1.,-1.,m_amct,0,m_kTC_0_5_1__4_23[0],m_kTC_0_5_1__4_23[1]);
  wt *= m_kTC_0_5_1__4_23.Weight();

  rans[4]= m_kTC_0_5_1__4_23[0];
  rans[5]= m_kTC_0_5_1__4_23[1];
       ...
       : Single_Channel(nin,nout,fl)
{
  ...
  m_kTC_0_5_1__4_23.Assign(std::string("TC_0_5_1__4_23"),2,0,info);
...
{
  return std::string("CG2$I_2_3$MP23_23$MTH_234$TC_0_5_1__4_23$TC_0__1__5_234$ZS_205$");
}
