...
namespace PHASIC {
  class C4_26 : public Single_Channel {
    double m_amct,m_alpha,m_ctmax,m_ctmin;
    Info_Key m_kI_2_3,m_kTC_0__1_5_4_23,m_kTC_0__1__234_5,m_kZS_205;
    Vegas* p_vegas;
  public:
    C4_26(int,int,Flavour*,Integration_Info * const);
    ~C4_26();
...
extern "C" Single_Channel * Getter_C4_26(int nin,int nout,Flavour* fl,Integration_Info * const info) {
  return new C4_26(nin,nout,fl,info);
}

void C4_26::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  s234_min = Max(s234_min,sqr(sqrt(s4)+sqrt(s23)));
  Vec4D  p234;
  ...
  Vec4D  p1_5 = p[1]-p[5];
  CE.TChannelMomenta(p[0],p1_5,p[4],p23,s4,s23,0.,m_alpha,1.,-1.,m_amct,0,ran[4],ran[5]);
  CE.Isotropic2Momenta(p23,s2,s3,p[2],p[3],ran[6],ran[7]);
}

void C4_26::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  double wt = 1.;
  Vec4D p2345=p[0]+p[1];
  double s2345_max = p2345.Abs2();
  ...
  Vec4D  p1_5 = p[1]-p[5];
  if (m_kTC_0__1_5_4_23.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0__1_5_4_23<<CE.TChannelWeight(p[0],p1_5,p[4],p23,0.,m_alpha,1.,-1.,m_amct,0,m_kTC_0__1_5_4_23[0],m_kTC_0__1_5_4_23[1]);
  wt *= m_kTC_0__1_5_4_23.Weight();

  rans[4]= m_kTC_0__1_5_4_23[0];
  rans[5]= m_kTC_0__1_5_4_23[1];
...
C4_26::C4_26(int nin,int nout,Flavour* fl,Integration_Info * const info)
       : Single_Channel(nin,nout,fl)
{
  name = std::string("C4_26");
  rannum = 8;
  ...
  m_kTC_0__1_5_4_23.Assign(std::string("TC_0__1_5_4_23"),2,0,info);
...
void C4_26::ISRInfo(int & type,double & mass,double & width)
{
  type  = 2;
  mass  = 205.1721;
  width = 0.;
...
void C4_26::AddPoint(double Value)
{
  Single_Channel::AddPoint(Value);
  p_vegas->AddPoint(Value,rans);
}
std::string C4_26::ChID()
{
  return std::string("CG2$I_2_3$MP23_23$MTH_234$TC_0__1_5_4_23$TC_0__1__234_5$ZS_205$");
}
