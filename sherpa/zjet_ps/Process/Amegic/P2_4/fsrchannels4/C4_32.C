...
namespace PHASIC {
  class C4_32 : public Single_Channel {
    double m_amct,m_alpha,m_ctmax,m_ctmin;
    Info_Key m_kI_2_3,m_kTC_0_4_1__23_5,m_kTC_0__1__4_235,m_kZS_205;
    Vegas* p_vegas;
  public:
    C4_32(int,int,Flavour*,Integration_Info * const);
    ~C4_32();
...
extern "C" Single_Channel * Getter_C4_32(int nin,int nout,Flavour* fl,Integration_Info * const info) {
  return new C4_32(nin,nout,fl,info);
}

void C4_32::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  s235_min = Max(s235_min,sqr(sqrt(s23)+sqrt(s5)));
  Vec4D  p235;
  ...
  Vec4D  p0_4 = p[0]-p[4];
  CE.TChannelMomenta(p0_4,p[1],p23,p[5],s23,s5,0.,m_alpha,1.,-1.,m_amct,0,ran[4],ran[5]);
  CE.Isotropic2Momenta(p23,s2,s3,p[2],p[3],ran[6],ran[7]);
}

void C4_32::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  double wt = 1.;
  Vec4D p2345=p[0]+p[1];
  double s2345_max = p2345.Abs2();
  ...
  Vec4D  p0_4 = p[0]-p[4];
  if (m_kTC_0_4_1__23_5.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0_4_1__23_5<<CE.TChannelWeight(p0_4,p[1],p23,p[5],0.,m_alpha,1.,-1.,m_amct,0,m_kTC_0_4_1__23_5[0],m_kTC_0_4_1__23_5[1]);
  wt *= m_kTC_0_4_1__23_5.Weight();

  rans[4]= m_kTC_0_4_1__23_5[0];
  rans[5]= m_kTC_0_4_1__23_5[1];
...
C4_32::C4_32(int nin,int nout,Flavour* fl,Integration_Info * const info)
       : Single_Channel(nin,nout,fl)
{
  name = std::string("C4_32");
  rannum = 8;
  ...
  m_kTC_0_4_1__23_5.Assign(std::string("TC_0_4_1__23_5"),2,0,info);
...
void C4_32::ISRInfo(int & type,double & mass,double & width)
{
  type  = 2;
  mass  = 205.1721;
  width = 0.;
...
void C4_32::AddPoint(double Value)
{
  Single_Channel::AddPoint(Value);
  p_vegas->AddPoint(Value,rans);
}
std::string C4_32::ChID()
{
  return std::string("CG2$I_2_3$MP23_23$MTH_235$TC_0_4_1__23_5$TC_0__1__4_235$ZS_205$");
}
