...
extern "C" Values* Getter_V2_4__G__db__em__ep__G__db__S1_4(Basic_Sfuncs* bs) {
  return new V2_4__G__db__em__ep__G__db__S1_4(bs);
}

V2_4__G__db__em__ep__G__db__S1_4::V2_4__G__db__em__ep__G__db__S1_4(Basic_Sfuncs* _BS) :
     Basic_Func(0,_BS),
     Basic_Zfunc(0,_BS),
     Basic_Xfunc(0,_BS),
     Basic_Vfunc(0,_BS),
...
V2_4__G__db__em__ep__G__db__S1_4::~V2_4__G__db__em__ep__G__db__S1_4()
{
  if (Z)  delete[] Z;
  if (f)  delete[] f;
  if (c)  delete[] c;
...
Complex V2_4__G__db__em__ep__G__db__S1_4::Evaluate(int m,int n)
{
...
void V2_4__G__db__em__ep__G__db__S1_4::Calculate_M0()
{
...
void V2_4__G__db__em__ep__G__db__S1_4::Calculate_M1()
{
...
void V2_4__G__db__em__ep__G__db__S1_4::Calculate_M2()
{
...
void V2_4__G__db__em__ep__G__db__S1_4::Calculate_M3()
{
  M[3][2] = -(Z[262]*Z[223]-Z[97]*Z[225])*Z[113];
  M[3][4] = Z[143]*Z[220]*Z[264];
}

void V2_4__G__db__em__ep__G__db__S1_4::Calculate_M12()
{
...
void V2_4__G__db__em__ep__G__db__S1_4::Calculate_M13()
{
...
void V2_4__G__db__em__ep__G__db__S1_4::Calculate_M14()
{
...
void V2_4__G__db__em__ep__G__db__S1_4::Calculate_M15()
{
  M[15][2] = -(Z[262]*Z[369]-Z[97]*Z[371])*Z[113];
  M[15][4] = Z[143]*Z[220]*Z[386];
}

void V2_4__G__db__em__ep__G__db__S1_4::Calculate_M16()
{
...
void V2_4__G__db__em__ep__G__db__S1_4::Calculate_M17()
{
...
void V2_4__G__db__em__ep__G__db__S1_4::Calculate_M18()
{
...
void V2_4__G__db__em__ep__G__db__S1_4::Calculate_M19()
{
  M[19][2] = Z[113]*Z[410]*Z[225];
  M[19][4] = Z[143]*Z[220]*Z[453];
}

void V2_4__G__db__em__ep__G__db__S1_4::Calculate_M28()
{
