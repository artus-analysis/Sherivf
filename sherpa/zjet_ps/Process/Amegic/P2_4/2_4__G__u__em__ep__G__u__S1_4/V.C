...
extern "C" Values* Getter_V2_4__G__u__em__ep__G__u__S1_4(Basic_Sfuncs* bs) {
  return new V2_4__G__u__em__ep__G__u__S1_4(bs);
}

V2_4__G__u__em__ep__G__u__S1_4::V2_4__G__u__em__ep__G__u__S1_4(Basic_Sfuncs* _BS) :
     Basic_Func(0,_BS),
     Basic_Zfunc(0,_BS),
     Basic_Xfunc(0,_BS),
     Basic_Vfunc(0,_BS),
...
V2_4__G__u__em__ep__G__u__S1_4::~V2_4__G__u__em__ep__G__u__S1_4()
{
  if (Z)  delete[] Z;
  if (f)  delete[] f;
  if (c)  delete[] c;
...
Complex V2_4__G__u__em__ep__G__u__S1_4::Evaluate(int m,int n)
{
...
void V2_4__G__u__em__ep__G__u__S1_4::Calculate_M0()
{
...
void V2_4__G__u__em__ep__G__u__S1_4::Calculate_M1()
{
...
void V2_4__G__u__em__ep__G__u__S1_4::Calculate_M2()
{
  M[2][3] = -Z[135]*Z[127]*Z[256];
  M[2][5] = -Z[188]*Z[139]*Z[163];
}

void V2_4__G__u__em__ep__G__u__S1_4::Calculate_M3()
{
...
void V2_4__G__u__em__ep__G__u__S1_4::Calculate_M12()
{
...
void V2_4__G__u__em__ep__G__u__S1_4::Calculate_M13()
{
...
void V2_4__G__u__em__ep__G__u__S1_4::Calculate_M14()
{
  M[14][3] = -Z[135]*Z[127]*Z[387];
  M[14][5] = -Z[188]*Z[139]*Z[353];
}

void V2_4__G__u__em__ep__G__u__S1_4::Calculate_M15()
{
...
void V2_4__G__u__em__ep__G__u__S1_4::Calculate_M16()
{
...
void V2_4__G__u__em__ep__G__u__S1_4::Calculate_M17()
{
...
void V2_4__G__u__em__ep__G__u__S1_4::Calculate_M18()
{
  M[18][3] = -Z[135]*Z[127]*Z[449];
  M[18][5] = (Z[451]*Z[187]-Z[433]*Z[163])*Z[188];
}

void V2_4__G__u__em__ep__G__u__S1_4::Calculate_M19()
{
...
void V2_4__G__u__em__ep__G__u__S1_4::Calculate_M28()
{
