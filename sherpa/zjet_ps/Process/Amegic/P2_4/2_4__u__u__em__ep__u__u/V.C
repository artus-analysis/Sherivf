...
extern "C" Values* Getter_V2_4__u__u__em__ep__u__u(Basic_Sfuncs* bs) {
  return new V2_4__u__u__em__ep__u__u(bs);
}

V2_4__u__u__em__ep__u__u::V2_4__u__u__em__ep__u__u(Basic_Sfuncs* _BS) :
     Basic_Func(0,_BS),
     Basic_Zfunc(0,_BS),
     Basic_Pfunc(0,_BS)
{
...
V2_4__u__u__em__ep__u__u::~V2_4__u__u__em__ep__u__u()
{
  if (Z)  delete[] Z;
  if (f)  delete[] f;
  if (c)  delete[] c;
...
Complex V2_4__u__u__em__ep__u__u::Evaluate(int m,int n)
{
...
void V2_4__u__u__em__ep__u__u::Calculate_M0()
{
...
void V2_4__u__u__em__ep__u__u::Calculate_M1()
{
...
void V2_4__u__u__em__ep__u__u::Calculate_M12()
{
...
void V2_4__u__u__em__ep__u__u::Calculate_M13()
{
...
void V2_4__u__u__em__ep__u__u::Calculate_M16()
{
...
void V2_4__u__u__em__ep__u__u::Calculate_M17()
{
...
void V2_4__u__u__em__ep__u__u::Calculate_M18()
{
...
void V2_4__u__u__em__ep__u__u::Calculate_M19()
{
...
void V2_4__u__u__em__ep__u__u::Calculate_M28()
{
...
void V2_4__u__u__em__ep__u__u::Calculate_M29()
{
...
void V2_4__u__u__em__ep__u__u::Calculate_M30()
{
...
void V2_4__u__u__em__ep__u__u::Calculate_M31()
{
...
void V2_4__u__u__em__ep__u__u::Calculate_M32()
{
