...
extern "C" Values* Getter_V2_4__G__G__em__ep__u__ub(Basic_Sfuncs* bs) {
  return new V2_4__G__G__em__ep__u__ub(bs);
}

V2_4__G__G__em__ep__u__ub::V2_4__G__G__em__ep__u__ub(Basic_Sfuncs* _BS) :
     Basic_Func(0,_BS),
     Basic_Zfunc(0,_BS),
     Basic_Xfunc(0,_BS),
     Basic_Vfunc(0,_BS),
...
V2_4__G__G__em__ep__u__ub::~V2_4__G__G__em__ep__u__ub()
{
  if (Z)  delete[] Z;
  if (f)  delete[] f;
  if (c)  delete[] c;
...
Complex V2_4__G__G__em__ep__u__ub::Evaluate(int m,int n)
{
...
void V2_4__G__G__em__ep__u__ub::Calculate_M0()
{
...
void V2_4__G__G__em__ep__u__ub::Calculate_M1()
{
...
void V2_4__G__G__em__ep__u__ub::Calculate_M2()
{
...
void V2_4__G__G__em__ep__u__ub::Calculate_M3()
{
...
void V2_4__G__G__em__ep__u__ub::Calculate_M12()
{
...
void V2_4__G__G__em__ep__u__ub::Calculate_M13()
{
...
void V2_4__G__G__em__ep__u__ub::Calculate_M14()
{
...
void V2_4__G__G__em__ep__u__ub::Calculate_M15()
{
...
void V2_4__G__G__em__ep__u__ub::Calculate_M16()
{
...
void V2_4__G__G__em__ep__u__ub::Calculate_M17()
{
  M[17][3] = -(Z[113]*Z[207]-Z[211]*Z[205])*Z[128];
  M[17][6] = -(Z[138]*Z[362]-Z[143]*Z[364])*Z[191];
}

void V2_4__G__G__em__ep__u__ub::Calculate_M18()
{
