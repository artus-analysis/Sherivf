...
extern "C" Values* Getter_V2_4__c__u__em__ep__u__c__S0_5(Basic_Sfuncs* bs) {
  return new V2_4__c__u__em__ep__u__c__S0_5(bs);
}

V2_4__c__u__em__ep__u__c__S0_5::V2_4__c__u__em__ep__u__c__S0_5(Basic_Sfuncs* _BS) :
     Basic_Func(0,_BS),
     Basic_Zfunc(0,_BS),
     Basic_Pfunc(0,_BS)
{
...
V2_4__c__u__em__ep__u__c__S0_5::~V2_4__c__u__em__ep__u__c__S0_5()
{
  if (Z)  delete[] Z;
  if (f)  delete[] f;
  if (c)  delete[] c;
...
Complex V2_4__c__u__em__ep__u__c__S0_5::Evaluate(int m,int n)
{
...
void V2_4__c__u__em__ep__u__c__S0_5::Calculate_M0()
{
...
void V2_4__c__u__em__ep__u__c__S0_5::Calculate_M12()
{
...
void V2_4__c__u__em__ep__u__c__S0_5::Calculate_M18()
{
...
void V2_4__c__u__em__ep__u__c__S0_5::Calculate_M30()
{
...
void V2_4__c__u__em__ep__u__c__S0_5::Calculate_M33()
{
...
void V2_4__c__u__em__ep__u__c__S0_5::Calculate_M45()
{
...
void V2_4__c__u__em__ep__u__c__S0_5::Calculate_M51()
{
...
void V2_4__c__u__em__ep__u__c__S0_5::Calculate_M63()
{
