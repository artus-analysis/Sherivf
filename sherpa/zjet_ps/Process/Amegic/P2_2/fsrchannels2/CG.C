  ...
  public:
    ...
    Single_Channel *LoadChannel(int nin,int nout,Flavour* fl,const std::string &pID,Phase_Space_Handler *psh)
    {
      ...
      Lib_Getter_Function gf = (Lib_Getter_Function)
        PT(s_loader->GetLibraryFunction("Proc_fsrchannels2","Getter_"+pID));
...
DECLARE_GETTER(fsrchannels2_Channel_Generator,"fsrchannels2",Channel_Generator,Channel_Generator_Key);
...
PrintInfo(std::ostream &str,const size_t width) const { str<<"fsrchannels2"; }
