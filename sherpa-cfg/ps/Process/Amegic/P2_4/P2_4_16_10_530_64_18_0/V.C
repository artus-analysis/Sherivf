...
extern "C" Values* Getter_VP2_4_16_10_530_64_18_0(Basic_Sfuncs* bs) {
  return new VP2_4_16_10_530_64_18_0(bs);
}

VP2_4_16_10_530_64_18_0::VP2_4_16_10_530_64_18_0(Basic_Sfuncs* _BS) :
     Basic_Func(0,_BS),
     Basic_Zfunc(0,_BS),
     Basic_Xfunc(0,_BS),
     Basic_Vfunc(0,_BS),
...
VP2_4_16_10_530_64_18_0::~VP2_4_16_10_530_64_18_0()
{
  if (Z)  delete[] Z;
  if (f)  delete[] f;
  if (c)  delete[] c;
...
Complex VP2_4_16_10_530_64_18_0::Evaluate(int m,int n)
{
...
void VP2_4_16_10_530_64_18_0::Calculate_M0()
{
...
void VP2_4_16_10_530_64_18_0::Calculate_M1()
{
...
void VP2_4_16_10_530_64_18_0::Calculate_M2()
{
  M[2][3] = -Z[135]*Z[127]*Z[256];
  M[2][5] = -Z[188]*Z[139]*Z[163];
}

void VP2_4_16_10_530_64_18_0::Calculate_M3()
{
...
void VP2_4_16_10_530_64_18_0::Calculate_M12()
{
...
void VP2_4_16_10_530_64_18_0::Calculate_M13()
{
...
void VP2_4_16_10_530_64_18_0::Calculate_M14()
{
  M[14][3] = -Z[135]*Z[127]*Z[387];
  M[14][5] = -Z[188]*Z[139]*Z[353];
}

void VP2_4_16_10_530_64_18_0::Calculate_M15()
{
...
void VP2_4_16_10_530_64_18_0::Calculate_M16()
{
...
void VP2_4_16_10_530_64_18_0::Calculate_M17()
{
...
void VP2_4_16_10_530_64_18_0::Calculate_M18()
{
  M[18][3] = -Z[135]*Z[127]*Z[449];
  M[18][5] = (Z[451]*Z[187]-Z[433]*Z[163])*Z[188];
}

void VP2_4_16_10_530_64_18_0::Calculate_M19()
{
...
void VP2_4_16_10_530_64_18_0::Calculate_M28()
{
