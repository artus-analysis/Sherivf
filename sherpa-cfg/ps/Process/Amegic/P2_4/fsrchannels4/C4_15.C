...
namespace PHASIC {
  class C4_15 : public Single_Channel {
    ...
    Info_Key m_kI_2_3,m_kTC_0__1_5_23_4,m_kTC_0__1__234_5,m_kZS_205;
    Vegas* p_vegas;
  public:
...
void C4_15::GeneratePoint(Vec4D * p,Cut_Data * cuts,double * _ran)
{
  ...
  Vec4D  p1_5 = p[1]-p[5];
  CE.TChannelMomenta(p[0],p1_5,p23,p[4],s23,s4,0.,m_alpha,1.,-1.,m_amct,0,ran[4],ran[5]);
...
void C4_15::GenerateWeight(Vec4D* p,Cut_Data * cuts)
{
  ...
  Vec4D  p1_5 = p[1]-p[5];
  if (m_kTC_0__1_5_23_4.Weight()==ATOOLS::UNDEFINED_WEIGHT)
    m_kTC_0__1_5_23_4<<CE.TChannelWeight(p[0],p1_5,p23,p[4],0.,m_alpha,1.,-1.,m_amct,0,m_kTC_0__1_5_23_4[0],m_kTC_0__1_5_23_4[1]);
  wt *= m_kTC_0__1_5_23_4.Weight();

  rans[4]= m_kTC_0__1_5_23_4[0];
  rans[5]= m_kTC_0__1_5_23_4[1];
       ...
       : Single_Channel(nin,nout,fl)
{
  ...
  m_kTC_0__1_5_23_4.Assign(std::string("TC_0__1_5_23_4"),2,0,info);
...
{
  return std::string("CG2$I_2_3$MP23_23$MTH_234$TC_0__1_5_23_4$TC_0__1__234_5$ZS_205$");
}
