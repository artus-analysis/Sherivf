...
extern "C" Values* Getter_VP2_4_16_10_434_64_18_1(Basic_Sfuncs* bs) {
  return new VP2_4_16_10_434_64_18_1(bs);
}

VP2_4_16_10_434_64_18_1::VP2_4_16_10_434_64_18_1(Basic_Sfuncs* _BS) :
     Basic_Func(0,_BS),
     Basic_Zfunc(0,_BS),
     Basic_Xfunc(0,_BS),
     Basic_Vfunc(0,_BS),
...
VP2_4_16_10_434_64_18_1::~VP2_4_16_10_434_64_18_1()
{
  if (Z)  delete[] Z;
  if (f)  delete[] f;
  if (c)  delete[] c;
...
Complex VP2_4_16_10_434_64_18_1::Evaluate(int m,int n)
{
...
void VP2_4_16_10_434_64_18_1::Calculate_M0()
{
...
void VP2_4_16_10_434_64_18_1::Calculate_M1()
{
...
void VP2_4_16_10_434_64_18_1::Calculate_M2()
{
...
void VP2_4_16_10_434_64_18_1::Calculate_M3()
{
...
void VP2_4_16_10_434_64_18_1::Calculate_M12()
{
...
void VP2_4_16_10_434_64_18_1::Calculate_M13()
{
...
void VP2_4_16_10_434_64_18_1::Calculate_M14()
{
...
void VP2_4_16_10_434_64_18_1::Calculate_M15()
{
...
void VP2_4_16_10_434_64_18_1::Calculate_M16()
{
...
void VP2_4_16_10_434_64_18_1::Calculate_M17()
{
  M[17][3] = -(Z[113]*Z[207]-Z[211]*Z[205])*Z[128];
  M[17][6] = -(Z[138]*Z[362]-Z[143]*Z[364])*Z[191];
}

void VP2_4_16_10_434_64_18_1::Calculate_M18()
{
