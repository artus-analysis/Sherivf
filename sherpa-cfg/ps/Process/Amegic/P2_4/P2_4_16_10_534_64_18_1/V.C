...
extern "C" Values* Getter_VP2_4_16_10_534_64_18_1(Basic_Sfuncs* bs) {
  return new VP2_4_16_10_534_64_18_1(bs);
}

VP2_4_16_10_534_64_18_1::VP2_4_16_10_534_64_18_1(Basic_Sfuncs* _BS) :
     Basic_Func(0,_BS),
     Basic_Zfunc(0,_BS),
     Basic_Xfunc(0,_BS),
     Basic_Vfunc(0,_BS),
...
VP2_4_16_10_534_64_18_1::~VP2_4_16_10_534_64_18_1()
{
  if (Z)  delete[] Z;
  if (f)  delete[] f;
  if (c)  delete[] c;
...
Complex VP2_4_16_10_534_64_18_1::Evaluate(int m,int n)
{
...
void VP2_4_16_10_534_64_18_1::Calculate_M0()
{
...
void VP2_4_16_10_534_64_18_1::Calculate_M1()
{
...
void VP2_4_16_10_534_64_18_1::Calculate_M2()
{
...
void VP2_4_16_10_534_64_18_1::Calculate_M3()
{
  M[3][2] = -(Z[263]*Z[224]-Z[98]*Z[226])*Z[114];
  M[3][4] = Z[144]*Z[221]*Z[265];
}

void VP2_4_16_10_534_64_18_1::Calculate_M12()
{
...
void VP2_4_16_10_534_64_18_1::Calculate_M13()
{
...
void VP2_4_16_10_534_64_18_1::Calculate_M14()
{
...
void VP2_4_16_10_534_64_18_1::Calculate_M15()
{
  M[15][2] = -(Z[263]*Z[370]-Z[98]*Z[372])*Z[114];
  M[15][4] = Z[144]*Z[221]*Z[387];
}

void VP2_4_16_10_534_64_18_1::Calculate_M16()
{
...
void VP2_4_16_10_534_64_18_1::Calculate_M17()
{
...
void VP2_4_16_10_534_64_18_1::Calculate_M18()
{
...
void VP2_4_16_10_534_64_18_1::Calculate_M19()
{
  M[19][2] = -(Z[454]*Z[224]-Z[411]*Z[226])*Z[114];
  M[19][4] = Z[144]*Z[221]*Z[456];
}

void VP2_4_16_10_534_64_18_1::Calculate_M28()
{
