...
extern "C" Values* Getter_VP2_4_16_10_530_64_18_3(Basic_Sfuncs* bs) {
  return new VP2_4_16_10_530_64_18_3(bs);
}

VP2_4_16_10_530_64_18_3::VP2_4_16_10_530_64_18_3(Basic_Sfuncs* _BS) :
     Basic_Func(0,_BS),
     Basic_Zfunc(0,_BS),
     Basic_Xfunc(0,_BS),
     Basic_Vfunc(0,_BS),
...
VP2_4_16_10_530_64_18_3::~VP2_4_16_10_530_64_18_3()
{
  if (Z)  delete[] Z;
  if (f)  delete[] f;
  if (c)  delete[] c;
...
Complex VP2_4_16_10_530_64_18_3::Evaluate(int m,int n)
{
...
void VP2_4_16_10_530_64_18_3::Calculate_M0()
{
...
void VP2_4_16_10_530_64_18_3::Calculate_M1()
{
...
void VP2_4_16_10_530_64_18_3::Calculate_M2()
{
...
void VP2_4_16_10_530_64_18_3::Calculate_M3()
{
  M[3][2] = -(Z[262]*Z[223]-Z[97]*Z[225])*Z[113];
  M[3][4] = Z[143]*Z[220]*Z[264];
}

void VP2_4_16_10_530_64_18_3::Calculate_M12()
{
...
void VP2_4_16_10_530_64_18_3::Calculate_M13()
{
...
void VP2_4_16_10_530_64_18_3::Calculate_M14()
{
...
void VP2_4_16_10_530_64_18_3::Calculate_M15()
{
  M[15][2] = -(Z[262]*Z[369]-Z[97]*Z[371])*Z[113];
  M[15][4] = Z[143]*Z[220]*Z[386];
}

void VP2_4_16_10_530_64_18_3::Calculate_M16()
{
...
void VP2_4_16_10_530_64_18_3::Calculate_M17()
{
...
void VP2_4_16_10_530_64_18_3::Calculate_M18()
{
...
void VP2_4_16_10_530_64_18_3::Calculate_M19()
{
  M[19][2] = Z[113]*Z[410]*Z[225];
  M[19][4] = Z[143]*Z[220]*Z[453];
}

void VP2_4_16_10_530_64_18_3::Calculate_M28()
{
