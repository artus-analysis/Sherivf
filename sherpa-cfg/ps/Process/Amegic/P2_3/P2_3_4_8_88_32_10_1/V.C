...
extern "C" Values* Getter_VP2_3_4_8_88_32_10_1(Basic_Sfuncs* bs) {
  return new VP2_3_4_8_88_32_10_1(bs);
}

VP2_3_4_8_88_32_10_1::VP2_3_4_8_88_32_10_1(Basic_Sfuncs* _BS) :
     Basic_Func(0,_BS),
     Basic_Zfunc(0,_BS),
     Basic_Xfunc(0,_BS),
     Basic_Pfunc(0,_BS)
...
VP2_3_4_8_88_32_10_1::~VP2_3_4_8_88_32_10_1()
{
  if (Z)  delete[] Z;
  if (f)  delete[] f;
  if (c)  delete[] c;
...
Complex VP2_3_4_8_88_32_10_1::Evaluate(int m,int n)
{
...
void VP2_3_4_8_88_32_10_1::Calculate_M0()
{
  M[0][0] = -(Z[18]*Z[17]-Z[8]*Z[7])*Z[19];
}

void VP2_3_4_8_88_32_10_1::Calculate_M1()
{
  M[1][0] = -Z[19]*Z[30]*Z[17];
  M[1][1] = -Z[28]*Z[31]*Z[23];
}

void VP2_3_4_8_88_32_10_1::Calculate_M2()
{
  M[2][0] = (Z[13]*Z[40]+Z[8]*Z[36])*Z[19];
  M[2][1] = -(Z[46]*Z[27]+Z[45]*Z[23])*Z[28];
}

void VP2_3_4_8_88_32_10_1::Calculate_M3()
{
  M[3][0] = Z[19]*Z[29]*Z[40];
}

void VP2_3_4_8_88_32_10_1::Calculate_M12()
{
  M[12][0] = -(Z[18]*Z[55]-Z[8]*Z[49])*Z[19];
}

void VP2_3_4_8_88_32_10_1::Calculate_M13()
{
  M[13][0] = -Z[19]*Z[30]*Z[55];
  M[13][1] = -Z[28]*Z[31]*Z[58];
}

void VP2_3_4_8_88_32_10_1::Calculate_M14()
{
  M[14][0] = (Z[13]*Z[67]+Z[8]*Z[64])*Z[19];
  M[14][1] = -(Z[46]*Z[61]+Z[45]*Z[58])*Z[28];
}

void VP2_3_4_8_88_32_10_1::Calculate_M15()
{
  M[15][0] = Z[19]*Z[29]*Z[67];
}

void VP2_3_4_8_88_32_10_1::Calculate_M16()
{
  M[16][0] = Z[19]*Z[71]*Z[7];
}

void VP2_3_4_8_88_32_10_1::Calculate_M17()
{
  M[17][0] = (Z[81]*Z[12]+Z[80]*Z[7])*Z[19];
  M[17][1] = -(Z[32]*Z[79]+Z[31]*Z[75])*Z[28];
}

void VP2_3_4_8_88_32_10_1::Calculate_M18()
{
  M[18][0] = -Z[19]*Z[18]*Z[44];
  M[18][1] = -Z[28]*Z[46]*Z[79];
}

void VP2_3_4_8_88_32_10_1::Calculate_M19()
{
  M[19][0] = -(Z[30]*Z[44]-Z[81]*Z[40])*Z[19];
}

void VP2_3_4_8_88_32_10_1::Calculate_M28()
{
  M[28][0] = Z[19]*Z[71]*Z[49];
}

void VP2_3_4_8_88_32_10_1::Calculate_M29()
{
  M[29][0] = (Z[81]*Z[52]+Z[80]*Z[49])*Z[19];
  M[29][1] = -(Z[32]*Z[87]+Z[31]*Z[84])*Z[28];
}

void VP2_3_4_8_88_32_10_1::Calculate_M30()
{
  M[30][0] = -Z[19]*Z[18]*Z[70];
  M[30][1] = -Z[28]*Z[46]*Z[87];
}

void VP2_3_4_8_88_32_10_1::Calculate_M31()
{
