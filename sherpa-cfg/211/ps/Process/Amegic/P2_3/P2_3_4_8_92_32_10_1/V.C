...
extern "C" Values* Getter_VP2_3_4_8_92_32_10_1(Basic_Sfuncs* bs) {
  return new VP2_3_4_8_92_32_10_1(bs);
}

VP2_3_4_8_92_32_10_1::VP2_3_4_8_92_32_10_1(Basic_Sfuncs* _BS) :
     Basic_Func(0,_BS),
     Basic_Zfunc(0,_BS),
     Basic_Xfunc(0,_BS),
     Basic_Pfunc(0,_BS)
...
VP2_3_4_8_92_32_10_1::~VP2_3_4_8_92_32_10_1()
{
  if (Z)  delete[] Z;
  if (f)  delete[] f;
  if (c)  delete[] c;
...
Complex VP2_3_4_8_92_32_10_1::Evaluate(int m,int n)
{
