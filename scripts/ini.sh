...
# aliases
alias rivbuild_nofastnlo="rivet-buildplugin -std=c++0x RivetMyAnalyses.so MCgrid_CMS_2015_Zee.cc -std=c++0x -Wl,--export-dynamic,-z,defs  $(pkg-config mcgrid --cflags) $(pkg-config mcgrid --libs)  -lHepMC -lYODA"
